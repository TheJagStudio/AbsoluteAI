...
function DashboardNavbar() {
    return (
        <nav className="block backdrop-saturate-200 backdrop-blur-2xl bg-opacity-80 border-b-2 border-customBlack w-full mx-auto max-w-full px-8 text-white transition-all sticky top-0 z-40 py-3">
            <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
                <div className="capitalize">
                    <nav aria-label="breadcrumb" className="w-max">
                        <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all mt-1">
                ...
                <div className="flex items-center">
                    <a href="#/auth/sign-in">
                        <button className="align-middle select-none font-sans font-bold text-center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-blue-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30 hidden items-center gap-1 px-4 xl:flex normal-case" type="button">
